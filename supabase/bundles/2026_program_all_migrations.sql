-- ============================================================================
-- TÜV Rheinland Academy PH — System-review build program (phases A–N + QA hardening)
-- Combined migration bundle. Generated from supabase/migrations/*.
--
-- Paste this whole file into the Supabase SQL editor and run once. Every
-- statement is idempotent, so re-running is safe. Files are concatenated in
-- dependency order; do not reorder the sections.
-- ============================================================================
