...
> **v2.5 integration note (2026-08-31):** This is the preserved v1 as-built specification and functional evidence source. It is not the architecture of the replacement portal. Current target specifications and capability dispositions are in `ARCHITECTURE.md`, `DATA-MODEL.md`, and `system-rebuild/15-final-parity-report.md`.
