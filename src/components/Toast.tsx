...
// user (and anyone reading) has time to react before auto-dismiss.
  ...
  const renderToast = (t: ToastItem) => (
    ...
    >
      ...
      <button
        ...
        onClick={() => remove(t.id)}
        style={{ marginLeft: 'auto', background: 'none', border: 'none', color: 'inherit', cursor: 'pointer', fontSize: 16, lineHeight: 1, padding: '0 2px' }}
      >
        ×
      </button>
    </div>
