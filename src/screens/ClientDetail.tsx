...
export default function ClientDetail() {
  ...
  // The database lets super_admin, coordinator, operations and business_owner
  // update any client, plus the owning salesperson their own — so the same set
  // may set its organization. The org_id field only exists once the migration is
  // applied; hide the control until then.
